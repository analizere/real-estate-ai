  ...
  async stage1Enrich(address: string): Promise<Stage1EnrichmentResult> {
    ...
    if (normalized.toLowerCase().includes('error')) {
      return {
        ...
        lot_size_sqft: makeField(null, 'county_api', CACHE_TTL.STATIC, now),
        zoning_code: makeField(null, 'county_api', CACHE_TTL.STATIC, now),
        beds: makeField(null, 'county_api', CACHE_TTL.STATIC, now),
        baths: makeField(null, 'county_api', CACHE_TTL.STATIC, now),
        sqft: makeField(null, 'county_api', CACHE_TTL.STATIC, now),
        year_built: makeField(null, 'county_api', CACHE_TTL.STATIC, now),
        owner_name: makeField(null, 'county_api', CACHE_TTL.STATIC, now),
        parcel_number: makeField(null, 'county_api', CACHE_TTL.STATIC, now),
        last_sale_date: makeField(null, 'county_api', CACHE_TTL.SEMI_STATIC, now),
        last_sale_price: makeField(null, 'county_api', CACHE_TTL.SEMI_STATIC, now),
        tax_assessed_value: makeField(null, 'county_api', CACHE_TTL.SEMI_STATIC, now),
        parcel_boundaries: makeField(null, 'gis_api', CACHE_TTL.STATIC, now),
        frontage_street_ft: makeField(null, 'gis_api', CACHE_TTL.STATIC, now),
        frontage_alley_ft: makeField(null, 'gis_api', CACHE_TTL.STATIC, now),
        building_footprint_sqft: makeField(null, 'gis_api', CACHE_TTL.STATIC, now),
